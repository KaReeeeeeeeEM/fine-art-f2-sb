# Fine Art for Secondary Schools — ADT Bundle Reference
...
**Fine Art for Secondary Schools** — This is an English-language Fine Art textbook for Form Two secondary students in Tanzania, published by the Tanzania Institute of Education and aligned with the national Ordinary Secondary Education syllabus. It introduces students to art theories such as formalism and functionalism, still life composition, functional drawing and painting, and monoprinting, with a strong emphasis on practical studio skills, analysis, and the social uses of art. The book appears aimed at lower secondary learners and uses a competency-based, activity-centered approach with exercises, projects, and portfolio work to connect creativity, design, culture, and everyday life.
...
├── fine-art-f2-sb.db                    # SQLite database (pipeline state)
├── fine-art-f2-sb.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Certificate of Approval from the United Republic of Tanzania Ministry of Education, Science and Technology for “Fine Art for Secondary Schools Student’s Book Form Two,” published and authored by the Tanzania Institute of Education, approved on 31st May 2025 for Form Two students under the 2023 syllabus, signed by Commissioner for Education Dr. Lyabwene M. Mtahabwa.",
  "gl001": "abstract",
  "gl001_def": "not showing things exactly as they appear in real life; often based on ideas, feelings, or shapes"
}
```
...
```json
{
  "abstract": {
    "word": "abstract",
    "definition": "not showing things exactly as they appear in real life; often based on ideas, feelings, or shapes",
    "variations": ["abstract","abstraction","abstract paintings"],
    "emoji": "🌀🎨"
  }
}
```
...
| Original PDF | `fine-art-f2-sb.pdf` |
| Pipeline database | `fine-art-f2-sb.db` (SQLite) |
